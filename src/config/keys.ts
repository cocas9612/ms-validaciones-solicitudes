export namespace Keys {
  export const carpetaArchivoComprimido = '../../archivos/comprimidos';
  export const nombreCampoArchivoComprimido = 'file';
  export const extensionesPermitidas: string[] = ['.RAR', '.ZIP'];
  ...
  export const rol_administrador = "6182f9183c21c2334c6b35a9";
